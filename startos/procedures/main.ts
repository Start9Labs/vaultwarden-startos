...
export const main: ExpectedExports.main = setupMain<WrapperData>(
  async ({ effects, utils, started }) => {
    ...
    const webInterface = new NetworkInterfaceBuilder({
      ...
      name: 'Web UI',
      id: 'webui',
      description: 'The web interface of Vault warden',
      ui: true,
      basic: null,
      path: '',
      search: {},
    ...
    const adminReceipt = await new NetworkInterfaceBuilder({
      effects,
      name: 'Admin for the Web UI',
      id: 'adminWebui',
      description: 'The web interface of Vault warden',
      ui: true,
      basic: null,
      path: '/admin',
      search: {},
    }).export([torOriginHttp, torOriginHttps, ...lanOriginsHttps.all])
    ...
    const interfaceReceipt = exportInterfaces(webReceipt, adminReceipt)
